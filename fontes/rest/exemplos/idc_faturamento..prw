...
/*/
//-------------------------------------------------------------------
WSRESTFUL idc_faturamento DESCRIPTION 'endpoint idc_faturamento API' FORMAT "application/json,text/html"
    ...
    WSDATA aQueryString AS ARRAY OPTIONAL
 	...
 	WSMETHOD GET ProdList;
	    ...
	    WSSYNTAX "/api/v1/idc_faturamento" ;
        PATH "/api/v1/idc_faturamento" ;
...
/*/
//-------------------------------------------------------------------
WSMETHOD GET ProdList QUERYPARAM Page WSREST idc_faturamento
Return getList(self)
//-------------------------------------------------------------------
