...
Static Function AddMapFields( oSelf )
	...
	oSelf:AddMapFields( 'EMISSAO'           , 'D2_EMISSAO'  , .T., .T., { 'D2_EMISSAO'	, 'C', 8	, 0 } )
	...
	oSelf:AddMapFields( 'DESCRICAO'	    	, 'B1_DESC' 	, .T., .F., { 'B1_DESC'		, 'C', TamSX3( 'B1_DESC' )[1]	, 0 } )	
	oSelf:AddMapFields( 'UNMEDIDA'	    	, 'D2_UM' 		, .T., .F., { 'D2_UM'		, 'C', TamSX3( 'D2_UM' )[1]	, 0 } )	
	oSelf:AddMapFields( 'QAUNTIDADE'        , 'D2_QUANT'	, .T., .F., { 'D2_QUANT'	, 'N', TamSX3( 'D2_QUANT' )[1], 3 } )
	...
	oSelf:AddMapFields( 'VALIMP6'		    , 'D2_VALIMP6'	, .T., .F., { 'D2_VALIMP6'	, 'N', TamSX3( 'D2_VALIMP6' )[1], 2 } )
