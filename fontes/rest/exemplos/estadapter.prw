...
/*/
//-------------------------------------------------------------------
CLASS EstAdapter FROM FWAdapterBaseV2
	METHOD New()
	METHOD GetList()
EndClass
//-------------------------------------------------------------------
...
/*/
//-------------------------------------------------------------------
Method New( cVerb ) CLASS EstAdapter
	_Super:New( cVerb, .T. )
return
//-------------------------------------------------------------------
...
/*/
//-------------------------------------------------------------------
Method GetList( ) CLASS EstAdapter
	...
	cWhere := " B1_FILIAL = '"+ FWxFilial('SB1') +"' AND SB1.D_E_L_E_T_ = ' ' and BF_FILIAL = '"+ FWxFilial('SBF') +"' AND SBF.D_E_L_E_T_ = ' '"
	::SetWhere( cWhere )
...
Static Function AddMapFields( oSelf )
	...
	oSelf:AddMapFields( 'LOCALIZACAO'		, 'BF_LOCALIZ' 	, .T., .F., { 'BF_LOCALIZ'	, 'C', TamSX3( 'BF_LOCALIZ' )[1], 0 } )
	oSelf:AddMapFields( 'QUANTIDADE'		, 'BF_QUANT' 	, .T., .F., { 'BF_QUANT'	, 'N', TamSX3( 'BM_DESC' )[1]	, 3 } )
Return 
//-------------------------------------------------------------------
