...
/*/
//-------------------------------------------------------------------
WSRESTFUL idc_estoquesb2 DESCRIPTION 'endpoint idc_estoquesb2 API' FORMAT "application/json,text/html"
    ...
    WSMETHOD GET EstList;
	    ...
	    WSSYNTAX "/api/v1/idc_estoquesb2" ;
        PATH "/api/v1/idc_estoquesb2" ;
	    PRODUCES APPLICATION_JSON
 	
END WSRESTFUL
WSMETHOD GET EstList QUERYPARAM Page WSREST idc_estoquesb2
